...
-- ============================================================
-- SECTION 3: PLUGINS
-- Plugin configuration lives under lua/plugins/*.lua (one file per
-- concern) plus the official kickstart.plugins.* optional modules.
-- See `:help vim.pack` for how the built-in plugin manager works.
-- ============================================================
require 'plugins.build' -- vim.pack build hooks (telescope-fzf-native, LuaSnip, treesitter)
require 'plugins.ui' -- guess-indent, gitsigns, which-key, colorscheme, todo-comments, mini modules
require 'plugins.telescope' -- fuzzy finder + LSP pickers
require 'plugins.lsp' -- LSP keymaps, server configuration, Mason
...
-- Your own plugins, configuration, etc go in `lua/custom/plugins/*.lua`.
